...
#SBATCH --output=r50_trainxView2_all_strategies_%j.txt
#SBATCH --ntasks=1
...
config_path='trainxView2.r50_farseg_changemixin_mix'
model_dir='./log/changestar_sisup/r50_trainxView2_mix'

export LOCAL_RANK=0

torchrun --nproc_per_node=${NUM_GPUS} --master_port 6969 ./train_changemixin.py \
