...
from configs.trainxView2 import standard_self_pair
...
config = dict(
    ...
    data=standard_self_pair.data,
    optimizer=standard_self_pair.optimizer,
    learning_rate=standard_self_pair.learning_rate,
    train=standard_self_pair.train,
    test=standard_self_pair.test,
)
